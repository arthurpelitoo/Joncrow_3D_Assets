...
const targetTime = new Date("2025-06-30T00:00:00").getTime(); //Tempo limite
...
const promoBannerText = `Special Offer! Get the all-in-one bundle: 55 models at 50% off`
...
function updateTimer(){
    ...
    if(distance <= 0){
        banner_collapse.innerText = "Get the all-in-one bundle: 55 models";
        timerElement.classList.remove("active");
        section_badge.style.display = "none";
        section_title.innerText = "Bundle of 55 3D Model characters for $54 USD";
