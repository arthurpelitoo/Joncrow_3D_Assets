...
//captura o dominio sem o protocolo. localhost:8000, joncrow.rf.gd (servindo para montar o protocolo, dominio e o caminho base juntos)
$dominio = $_SERVER['HTTP_HOST'];

// define o caminho base, se rodando localmente passa o /siteJon/ ou se está em produção passa /
$basePath = ($dominio === 'localhost') ? '/siteJon/' : '/';

define('BASE_URL', $basePath);
// base url é pra caminho relativo: links entre paginas internas, css, js, imagens internas em html.

define('SITE_URL', $protocolo . '://' . $dominio);
// site url é pra caminho absoluto: SEO(og tags, twitter cards.) e redirecionamento via php.
...
// se nao achar o id, dá erro404
if ($page === "product" && !$idfound) {
    if($dominio !== 'localhost'){
        header("Location: " . SITE_URL . "/" . "erro404");
        exit;
    } else{
        $page = "erro404"; // pra funcionar em ambiente local.
    }
}
...
<head>
    ...
    if ($page === 'product' && $idfound) {
        $canonicalUrl = SITE_URL . "/product/" . $item['id'];
    } elseif (in_array($page, ['home', 'store', 'contact', 'FAQ', 'news'])) {
        $canonicalUrl = SITE_URL . "/" . $page;
    }
    ...
    <?php elseif ($page == "product"): ?>
        ...
        <meta property="og:url" content="<?= htmlspecialchars(SITE_URL . "/" . "product/" . $item['id']) ?>">
        <meta property="og:image" content="<?= htmlspecialchars(SITE_URL . $item['imagens'][0]) ?>">
        ...
        <meta name="twitter:image" content="<?= htmlspecialchars(SITE_URL . $item['imagens'][0]) ?>">
        <meta property="twitter:image:width" content="700">
        <meta property="twitter:image:height" content="700">
    ...
    <?php elseif ($page == "news"): ?>
        ...
        <meta property="og:image" content="<?= htmlspecialchars(SITE_URL . "/" . $ogImage) ?>">
        <meta property="og:url" content=<?= htmlspecialchars(SITE_URL . "/" . "news") ?>>

        <meta name="twitter:card" content="summary_large_image">
        <meta name="twitter:title" content="<?= $ogTitle ?> | New Update - Joncrow Asset Store">
        <meta name="twitter:description" content="<?= $ogDesc ?>">
        <meta name="twitter:image" content="<?= htmlspecialchars(SITE_URL . "/" . $ogImage) ?>">
...
<body>
    <header id="header">
        <div class="container">
            <div class="flex">
                <div class="flex-col1">
                    <a href="<?= BASE_URL ?>home" class="headerLogo" title="Home">
                ...
                <div class="flex-col2">
                    ...
                    <nav class="header-nav" id="header-nav">
                        <ul class="nav-ul">
                            <li class="nav-li"><a class="nav-btn" href="<?= BASE_URL ?>home" title="Home">Home</a></li>
